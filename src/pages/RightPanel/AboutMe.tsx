      ...
      <Grid item container flexDirection="column" gap={1} mt={2}>
        ...
        <Grid item container flexDirection="column" gap={1}>
          ...
          <Typography variant="body1" gutterBottom>
            저는 AI 머신러닝을 위한 GPU 관리 솔루션을 제공하는 AI 기업에서
            프론트엔드 개발자로 근무하며, GPU 예약 시스템 최적화와 리소스
            모니터링 UI 개선을 통해 사용자 경험과 성능을 크게 향상시켰습니다.
            특히 중복 예약 문제를 해결해 프로세스 효율성을 개선했으며, 컴포넌트
            재사용과 UI 최적화를 통해 개발 생산성을 높였습니다.
          </Typography>
        </Grid>
      </Grid>
      <Grid item container flexDirection="column" gap={1}>
